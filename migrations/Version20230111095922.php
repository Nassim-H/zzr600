 ...
 */
final class Version20230111095922 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coupons (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, coupons_types_id INTEGER NOT NULL, code VARCHAR(10) NOT NULL, description CLOB NOT NULL, discount INTEGER NOT NULL, max_usage INTEGER NOT NULL, validity DATETIME NOT NULL, is_valid BOOLEAN NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        ...
        $this->addSql('CREATE TABLE coupons_types (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(50) NOT NULL)');
        $this->addSql('CREATE TABLE images (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, products_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, CONSTRAINT FK_E01FBE6A6C8A81A9 FOREIGN KEY (products_id) REFERENCES products (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        , password VARCHAR(255) NOT NULL, lastname VARCHAR(100) NOT NULL, firstname VARCHAR(100) NOT NULL, address VARCHAR(255) NOT NULL, zipcode VARCHAR(5) NOT NULL, city VARCHAR(150) NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        )');
